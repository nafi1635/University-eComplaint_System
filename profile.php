...
?>
  ...
  <div class="col-sm-8" id="hi" style="padding-left:80px">
   ...
   <?php
    ...
    <div class="panel panel-info" style="background-color:#F1DDF6" >
            <div class="panel-heading" style="background-color:#E3BBED">
              <h3 class="panel-title" style="color:darkblue;" ><?php echo $row['fullname'];?></h3>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " > <img alt="User Pic" src="<?php echo $row['imagepath'];?>" class="img-circle img-responsive"> </div>
